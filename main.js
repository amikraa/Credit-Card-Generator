                ...
                methods: {
                    generate: function() {
                        ...
                        if (!("" === this.bin || this.bin.length < 6)) {
                            this.creditCards = "";
                            for (var e = 0; e < this.quantity; e++) this.creditCards += this.makeCC(), 0 === e && (t = this.creditCards), this.generateDate(), this.generateccv(), e < this.quantity - 1 && (this.creditCards += "\n");
                    ...
                    generateccv: function() {
                        if (this.ccvEnabled) return this.ccv ? this.creditCards += "|" + this.ccv : void(this.creditCards += "|" + this.rand(0, 9).toString() + this.rand(0, 9).toString() + this.rand(0, 9).toString() + (15 === this.length ? this.rand(0, 9).toString() : ""))
                    },
            ...
            a = Object(o.a)(i, function() {
                ...
                return n("form", {
                    ...
                    directives: [{
                        ...
                        rawName: "v-model",
                        value: t.ccvEnabled,
                        expression: "ccvEnabled"
                    }],
                    attrs: {
                        type: "checkbox"
                    },
                    domProps: {
                        checked: Array.isArray(t.ccvEnabled) ? t._i(t.ccvEnabled, null) > -1 : t.ccvEnabled
                    },
                    on: {
                        change: function(e) {
                            var n = t.ccvEnabled,
                            ...
                            if (Array.isArray(n)) {
                                var o = t._i(n, null);
                                r.checked ? o < 0 && (t.ccvEnabled = n.concat([null])) : o > -1 && (t.ccvEnabled = n.slice(0, o).concat(n.slice(o + 1)))
                            } else t.ccvEnabled = i
                        }
                    }
                })]), t._v(" "), n("input", {
                    ...
                    on: {
                        input: function(e) {
                            e.target.composing || (t.ccv = e.target.value)
                        }
                    }
                })])])]), t._v(" "), n("div", {
